...
su $instance -c "source $basedir/.nvm/nvm.sh && source $basedir/config/env && nvm use $nodever && npm install --quiet --save-prod yrexpert-js-testing >> $basedir/log/installerYrexpert-js-testing.log"
